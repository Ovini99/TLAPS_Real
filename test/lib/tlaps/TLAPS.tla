...
(**************************************************************************)
(* Backend pragma: MetiTarski theorem prover                              *)
(*                                                                        *)
(* This method translates the proof obligation to SMTLIB2 and calls the   *)
(* Metitarski theorem prover                                              *)
(* Z3 is used by default but you can also explicitly call it.             *)
(**************************************************************************)

METIT == TRUE (*{ by (prover: "metit") }*)
METITT(X) == TRUE (*{ by (prover:"metit"; timeout:@) }*)
