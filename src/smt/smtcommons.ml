...
let applyreal2u : unit pfuncs = Property.make "Backend.Smt.applyreal2u"
let apply_real2u x = Property.has x applyreal2u
...
let fmtasreal : unit pfuncs = Property.make "Backend.Smt.fmtasreal"
let fmt_as_real x = Property.has x fmtasreal
