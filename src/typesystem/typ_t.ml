...
let rec subst_reduce ss t: t =
    ...
    *)
    ...
    | [], _ ->
        t
    | _, (Int | Real | Bool | Str | TyAtom _ | Top) ->
        t
    | ss, TyVar (ss', a) ->
        TyVar (ss' @ ss, a)
    | ss, Set t ->
...
let rec unify_fails t1 t2 =
    ...
    | Set _,  Ref (_, t, _) ->
        unify_fails t1 t
    | (Set _ | Func _),
      (Int | Real | Bool | Str | Top) -> true
    | (Int | Real | Bool | Str | Top),
      (Set _ | Func _) -> true
    | Ref (_, a, _),
      ((Int | Real | Bool | Str) as b)
    | ((Int | Real | Bool | Str) as b),
      Ref (_, a, _)
    | Ref (_, a, _),
      (Top as b)
