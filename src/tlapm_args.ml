...
let show_version () =
  ...
  print_endline "Altered Support for Real Arithmetic: Version 1.0";
  exit 0
...
let init () =
  ...
  let opts = [
    ...
    title "(basic options)";
    blank;
    "--help", Arg.Unit show_help, " show this help message and exit ALTERED COPY FOR REAL ARITHMETIC SUPPORT" ;
