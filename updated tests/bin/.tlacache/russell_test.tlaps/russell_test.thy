...
(* BEGIN ZENON INPUT
;; file=.tlacache/russell_test.tlaps/tlapm_356e9a.znn; PATH='/home/ovini/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/snap/bin:/home/ovini/Downloads/tlapm_real/tlapm-main/tlapm-main/test/bin:/home/ovini/Downloads/tlapm_real/tlapm-main/tlapm-main/test/lib/tlaps/bin'; zenon -p0 -x tla -oisar -max-time 1d "$file" >.tlacache/russell_test.tlaps/tlapm_356e9a.znn.out
;; obligation #6
...
(* BEGIN ZENON INPUT
;; file=.tlacache/russell_test.tlaps/tlapm_886f6d.znn; PATH='/home/ovini/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/snap/bin:/home/ovini/Downloads/tlapm_real/tlapm-main/tlapm-main/test/bin:/home/ovini/Downloads/tlapm_real/tlapm-main/tlapm-main/test/lib/tlaps/bin'; zenon -p0 -x tla -oisar -max-time 1d "$file" >.tlacache/russell_test.tlaps/tlapm_886f6d.znn.out
;; obligation #8
$hyp "v'5" (A. ((a_CONSTANTunde_xunde_a) (TLA.in a_CONSTANTunde_xunde_a
a_CONSTANTunde_Vunde_a)))
$goal (=> (-. (TLA.in (TLA.subsetOf a_CONSTANTunde_Vunde_a ((a_CONSTANTunde_xunde_a) (-. (TLA.in a_CONSTANTunde_xunde_a
